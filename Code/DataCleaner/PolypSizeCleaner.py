...
class PolypSizeCleaner:
    ...
    def setSizeInWordsBasedOnSizeInMM(self):
        ...
        self.cleanedDataSet.loc[(self.cleanedDataSet[" Size (in mm)"].between(0,5)), "Size of Sessile in Words"] = "Small"
        self.cleanedDataSet.loc[(self.cleanedDataSet[" Size (in mm)"].between(6,9)), "Size of Sessile in Words"] = "Medium"
