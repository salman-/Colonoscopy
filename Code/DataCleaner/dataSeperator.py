...
class DataSeperator:
    ...
    def __init__(self,cleanedDTPath):
        ...
        self.dt = pd.read_csv(cleanedDTPath)
    ...
    def seperatePatient(self):
        ...
        dt = self.dt.iloc[:,0:11]

        paitentGroupQuery = """    select facility,patient_ID, year, month,count(*) as `Number of Capsules`
                                   from dt
    ...
    def printColumns(self,fromColumn,toColumn):
        print(self.dt.columns(np.r_[fromColumn:toColumn]))