...
#-----------------------------------------------------------
    ...
    def getProbability(self,observedStatesNumber, realStateNumber):
        ...
        proSmall = math.pow(self.smallSuccess, foundSmalls) * math.pow(self.smallFailure, missedSmall)
        proMedium = math.pow(self.mediumSuccess, foundMedium) * math.pow(self.mediumFailure, missedMedium)
        proLarge = math.pow(self.largeSuccess, foundLarge) * math.pow(self.largeFailure, missedLarge)
